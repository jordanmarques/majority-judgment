...
const Crown = props => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" height={props.height} width={props.width}>
        <path d="M52.9,42.9C51.4,32.4,42.6,24.4,32,24.4c-10.6,0-19.4,8-20.9,18.4H52.9z" fill="#428bc1"/>
        <path
            d="m61.8 22.9c-.4-1.8-1.5-3.2-3.1-4.1-.7-.4-1.5-.6-2.3-.7-.7-.1-1.4 0-2.1.2-1.2.3-2.4.9-3.5 1.4-1.5.7-2.9 1.4-4.2 1.4v4.6c2.3 0 4.4-1 6.2-1.9 1.9-.9 3.1-1.5 3.8-1.1.5.3.8.7.9 1.2.1.6.1 1.4-.1 2.3-.2 1-.7 2.1-1.3 3.4-1.2 2.5-2.8 4.9-4 6.7-.4.7-.8 1.3-1.1 1.7-.1.2-.2.4-.3.6 0 .1-.1.1-.1.2h-37c0-.1-.1-.1-.1-.2-.1-.2-.2-.4-.3-.6-.3-.5-.7-1.1-1.1-1.7-1.2-1.8-2.8-4.2-4-6.7-.6-1.3-1-2.4-1.3-3.4-.2-1-.3-1.8-.1-2.3.1-.5.4-.9.9-1.2.7-.4 1.9.1 3.8 1.1 1.8.9 3.8 1.9 6.2 1.9v-4.6c-1.3 0-2.7-.7-4.2-1.4-1.1-.6-2.3-1.1-3.5-1.4-.9-.2-1.6-.3-2.3-.2-.8.1-1.6.3-2.3.7-1.6.9-2.7 2.4-3.1 4.1-.5 2.3 0 5.2 1.8 8.8 1.3 2.7 3 5.3 4.3 7.2.4.6.8 1.2 1 1.6.1.2.2.4.4.6.6.9 1 1.6 1.2 2.4v11.3c-.3 0-.5.2-.5.6 0 .3.2.6.5.6h42.3c.3 0 .5-.2.5-.6 0-.3-.2-.6-.5-.6v-11.2c.3-.8.7-1.5 1.2-2.4.1-.2.2-.4.4-.6.2-.4.6-1 1-1.6 1.2-1.9 2.9-4.5 4.3-7.2 1.7-3.6 2.2-6.5 1.7-8.9"
            fill="#f2b200"/>
